...
var
  ...
  vCONF: TIniFile;
begin
  // Define o caminho do arquivo .ini no diretório do executável
  ...
  begin
    ...
    try
      ...
      ShowMessage('Arquivo conf.ini criado com valores padrão no diretório: ' + vIniPath);
    finally
      vCONF.Free;
    end;
  end;
  ...
  {$REGION 'CONFIGURAÇÕES E CONEXÃO'}
  try
