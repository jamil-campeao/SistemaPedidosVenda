object frmConsultaPedido: TfrmConsultaPedido
  ...
  object GradeConsulta: TDBGrid
    ...
    TitleFont.Style = []
    OnDblClick = GradeConsultaDblClick
    OnKeyDown = GradeConsultaKeyDown
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = 'Valor Total Pedido'
        Width = 112
        Visible = True
      end>
  end
  ...
  object sqlConsultaPedido: TFDQuery
    ...
    object sqlConsultaPedidoPEDIDO_NUMERO: TIntegerField
      FieldName = 'PEDIDO_NUMERO'
      Origin = 'PEDIDO_NUMERO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sqlConsultaPedidoCLIENTE_CODIGO: TIntegerField
      FieldName = 'CLIENTE_CODIGO'
      Origin = 'CLIENTE_CODIGO'
      Required = True
    end
    object sqlConsultaPedidoCLIENTE_NOME: TStringField
    ...
    object sqlConsultaPedidoPEDIDO_DATAEMISSAO: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'PEDIDO_DATAEMISSAO'
      Origin = 'PEDIDO_DATAEMISSAO'
    end
    object sqlConsultaPedidoPEDIDO_VALORTOTAL: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'PEDIDO_VALORTOTAL'
      Origin = 'PEDIDO_VALORTOTAL'
      DisplayFormat = '0.00'
      Precision = 14
      Size = 2
    end
